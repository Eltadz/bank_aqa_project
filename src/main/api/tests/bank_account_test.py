...
class TestBankAccount:
    ...
    def test_deposit_account_valid(self,amount):
        ...
        deposit_response = DepositBankAccountRequester(
            request_spec=RequestSpecs.auth_headers(username=username, password='Pas!sw0rd'),
            response_spec=ResponseSpecs.request_ok()
        ).post(deposit_bank_account_request)

        assert deposit_response.balance == amount
    ...
    def test_transfer_account_valid(self, amount):
        ...
        transfer_bank_account_request = TransferBankAccountRequest(fromAccountId=account_id_one,
                                                                   toAccountId=account_id_two, amount=amount)
